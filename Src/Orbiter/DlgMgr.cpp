...
DLLEXPORT struct ImGuiContext* GImGui = NULL;
...
void DialogManager::PrepareImGui()
{
...
void DialogManager::Notify(enum NotifType type, const char* title, const char* content)
{
