...
public:
	Instrument_Surface (Pane *_pane, MfdId _id, const Spec &spec, Vessel *_vessel);
	~Instrument_Surface();
...
private:
	...
	char title[40];
	uint32_t tapecol;
	int hrzx, hrzy, hrzr, hrzx0, hrzy0, hrzx1, hrzy1;
	int spdx0, accx0, vacx0, vspx0, altx0, aoax0, diry0, accy0, accy, accr;
