...
{
	static const char *name = "Orbiter 2006 Mars atmosphere model";
	return name;
}

DLLCLBK const char *ModelDesc ()
{
	static const char *desc = "A simple static Mars atmosphere model. This is the model used in Orbiter 2006.";
	return desc;
}