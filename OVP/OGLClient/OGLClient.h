...
public:
	 ...
	 */
	OGLClient (DynamicModule *hInstance);
...
public:
	...
	bool GetTextWidthAndHeight (const char *str, int len, int *width, int *top, int *bottom);
...
private:
	...
	oapi::Sketchpad::TAlign_horizontal m_TextAlignH;
	oapi::Sketchpad::TAlign_vertical m_TextAlignV;
...
// ======================================================================
/**
 * \brief A font resource for drawing text. This is a wrapper for a OGL
 *   texture object.
 */
...
//private:
	...
	GLuint m_Buffer;
	uint32_t m_Height;
	stbtt_packedchar m_CharData[256];
