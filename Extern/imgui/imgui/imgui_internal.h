...
extern __declspec(dllexport) ImGuiContext* GImGui;  // Current implicit context pointer
#else
extern __declspec(dllimport) ImGuiContext* GImGui;  // Current implicit context pointer
#endif
#endif
